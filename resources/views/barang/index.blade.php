    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <a href="{{ url('/barang/export') }}" class="btn btn-primary"><i class="fa fa-file-excel"></i> Export Barang Excel</a>
...
@push('js')
    <script>
        ...
        $(document).ready(function () {
            const tableBarang = $('#table-barang').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ url('barang/list') }}",
                ...
                columns: [
                    ...
                    { data: "kategori.kategori_nama", className: "", width: "14%" },
                    {
                        data: "aksi",
                        className: "text-center",
                        width: "14%",
            ...
            // Trigger pencarian hanya saat enter ditekan
