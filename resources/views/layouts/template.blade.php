...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('adminlte2/plugins/datatables-responsive/css/responsive.bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('adminlte2/plugins/datatables-buttons/css/buttons.bootstrap.min.css') }}">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/') }}" class="brand-link">
       <img src="{{ asset('adminlte2/dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
...
<script src="{{ asset('adminlte2/plugins/datatables-responsive/js/responsive.bootstrap.min.js') }}"></script>
<script src="{{ asset('adminlte2/plugins/datatables-buttons/js/dataTables.buttons.min.js') }}"></script>
<script src="{{ asset('adminlte2/plugins/datatables-buttons/js/buttons.bootstrap.min.js') }}"></script>
